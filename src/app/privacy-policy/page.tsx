...
export const metadata: Metadata = { title: "Privacy Policy | Velunna" };

export default function PrivacyPolicyPage() {
  return (
    <PolicyLayout title="Privacy Policy" updated="July 27, 2026">
      <p>
        Velunna operates this store and website, including all related
        information, content, features, tools, products and services, in
        order to provide you, the customer, with a curated shopping
        experience (the &quot;Services&quot;). Velunna is powered by
        ...
        us. If there is a conflict between our{" "}
        <a href="/terms-of-service">Terms of Service</a> and this Privacy
        Policy, this Privacy Policy controls with respect to the
      ...
      <ul>
        ...
        <li>
          ...
          actual litigation, or other adversarial legal proceedings, and to
          enforce or investigate potential violations of our terms or
          policies.
        </li>
      </ul>
      ...
      <ul>
        ...
        <li>
          ...
          and websites. You can exercise your rights to opt-out of those
          uses{" "}
          <a
            href="https://if11ad-ce.myshopify.com/pages/data-sharing-opt-out"
            target="_blank"
      ...
      <ul>
        ...
        <li>
          ...
          of the &quot;sale&quot; or &quot;share&quot; of your personal
          ...
          exercise your rights to opt-out of those uses{" "}
          <a
            href="https://if11ad-ce.myshopify.com/pages/data-sharing-opt-out"
            target="_blank"
            rel="noopener noreferrer"
          ...
          . Please note that if you visit our website with the Global
          ...
          opt-out for the device and browser that you use to visit the
          website. If we are able to associate the device sending the
          signal to a Shopify account, we will apply the opt out request
          to the account as well. To learn more about Global Privacy
          Control, you can visit{" "}
          <a
          ...
          other &quot;Do Not Track&quot; signals that may be sent from
      ...
      <p>
        ...
        exceptions and limitations provided by local law, you may exercise
        the following rights in addition to the rights outlined above:
      </p>
      <ul>
        <li>
          <strong>
        ...
        <li>
          ...
          withdraw this consent. If you withdraw your consent, this will
          not affect the lawfulness of any processing based on your
