...
export const metadata: Metadata = { title: "Terms of Service | Velunna" };

export default function TermsOfServicePage() {
  return (
    <PolicyLayout title="Terms of Service">
      <p>
        Welcome to Velunna! The terms &quot;we&quot;, &quot;us&quot; and
        &quot;our&quot; refer to Velunna. Velunna operates this store and
        website, including all related information, content, features,
        tools, products and services in order to provide you, the
        customer, with a curated shopping experience (the
        &quot;Services&quot;). Velunna is powered by Shopify, which enables
        us to provide the Services to you.
      </p>
      <p>
        The below terms and conditions, together with any policies
        referenced herein (these &quot;Terms of Service&quot; or
      ...
      <p>
        ...
        to these Terms of Service or Privacy Policy, you should not use or
        access our Services.
      </p>

      <h2>Section 1 &mdash; Access and Account</h2>
      <p>
      ...
      <h2>Section 2 &mdash; Our Products</h2>
      <p>
      ...
      <h2>Section 3 &mdash; Orders</h2>
      <p>
        When you place an order, you are making an offer to purchase.
        Velunna reserves the right to accept or decline your order for any
        reason at its discretion. Your order is not accepted until Velunna
        confirms acceptance. We must receive and process your payment
        before your order is accepted. Please review your order carefully
        before submitting, as Velunna may be unable to accommodate
        cancellation requests after an order is accepted. In the event
        that we do not accept, make a change to, or cancel an order, we
        will attempt to notify you by contacting the e&#8209;mail, billing
        address, and/or phone number provided at the time the order was
        made.
      </p>
      <p>
        Your purchases are subject to return or exchange solely in
        accordance with our <a href="/refund-policy">Refund Policy</a>.
      </p>
      <p>
      ...
      <h2>Section 4 &mdash; Prices and Billing</h2>
      <p>
      ...
      <p>
        ...
        information, including your email address, credit card numbers
      ...
      <h2>Section 5 &mdash; Shipping and Delivery</h2>
      <p>
      ...
      <h2>Section 6 &mdash; Intellectual Property</h2>
      <p>
        ...
        owned by Velunna, its affiliates or licensors and are protected by
      ...
      <p>
        ...
        property of Velunna, Shopify or any third party. Unauthorized use
        of the Services may be a violation of federal and state
        intellectual property laws. All rights not expressly granted
        herein are reserved by Velunna.
      </p>
      <p>
        Velunna&apos;s names, logos, product and service names, designs,
        and slogans are trademarks of Velunna or its affiliates or
        licensors. You must not use such trademarks without the prior
        written permission of Velunna. Shopify&apos;s name, logo, product
        and service names, designs and slogans are trademarks of Shopify.
      ...
      <h2>Section 7 &mdash; Optional Tools</h2>
      <p>
      ...
      <h2>Section 8 &mdash; Third-Party Links</h2>
      <p>
      ...
      <h2>Section 9 &mdash; Relationship with Shopify</h2>
      <p>
        Velunna is powered by Shopify, which enables us to provide the
        Services to you. However, any sales and purchases you make in our
        Store are made directly with Velunna. By using the Services, you
        acknowledge and agree that Shopify is not responsible for any
        aspect of any sales between you and Velunna, including any injury,
        damage, or loss resulting from purchased products and services.
        You hereby expressly release Shopify and its affiliates from all
        claims, damages, and liabilities arising from or related to your
        purchases and transactions with Velunna.
      </p>

      <h2>Section 10 &mdash; Privacy Policy</h2>
      <p>
        All personal information we collect through the Services is
        subject to our <a href="/privacy-policy">Privacy Policy</a>, and
        certain personal information may be subject to Shopify&apos;s{" "}
        <a
      ...
      <p>
        ...
        the Services in order to provide and improve the Services for you.
      ...
      <p>
        ...
        in any medium for any purpose, including for commercial use. We
        may, for example, use our rights under this license to operate,
        provide, evaluate, enhance, improve and promote the Services and
        to perform our obligations and exercise our rights under the Terms
        of Service.
      </p>
      <p>
      ...
      <p>
        ...
        are solely responsible for any Feedback you make and its
        accuracy. We take no responsibility and assume no liability for
        any Feedback posted by you or any third-party.
      </p>

      <h2>Section 12 &mdash; Errors, Inaccuracies and Omissions</h2>
      <p>
      ...
      <h2>Section 13 &mdash; Prohibited Uses</h2>
      <p>
        ...
        material that does not comply with these Terms; (g) to transmit,
        or procure the sending of, any advertising or promotional
        material, including any &quot;junk mail,&quot; &quot;chain
        letter,&quot; &quot;spam,&quot; or any other similar solicitation;
        (h) to impersonate or attempt to impersonate any other person or
        entity; or (i) to engage in any other conduct that restricts or
        inhibits anyone&apos;s use or enjoyment of the Services, or which,
        as determined by us, may harm Velunna, Shopify or users of the
      ...
      <h2>Section 14 &mdash; Termination</h2>
      <p>
      ...
      <p>
        ...
        Severability, Waiver; Entire Agreement, Assignment, Governing Law,
        Privacy Policy, and any other provisions that by their nature
        should survive termination.
      </p>

      <h2>Section 15 &mdash; Disclaimer of Warranties</h2>
      <p>
      ...
      <p>
        Except as expressly stated by Velunna, the Services and all
      ...
      <h2>Section 16 &mdash; Limitation of Liability</h2>
      <p>
        To the fullest extent provided by law, in no case shall Velunna,
      ...
      <h2>Section 17 &mdash; Indemnification</h2>
      <p>
        You agree to indemnify, defend and hold harmless Velunna, Shopify,
        ...
        the rights of a third party, or (3) your access to and use of the
        Services.
      </p>
      <p>
      ...
      <h2>Section 18 &mdash; Severability</h2>
      <p>
      ...
      <h2>Section 19 &mdash; Waiver; Entire Agreement</h2>
      <p>
      ...
      <h2>Section 20 &mdash; Assignment</h2>
      <p>
      ...
      <h2>Section 21 &mdash; Governing Law</h2>
      <p>
      ...
      <h2>Section 23 &mdash; Changes to Terms of Service</h2>
      <p>
      ...
      <p>
        ...
        website periodically for changes. We will notify you of any
        material changes to these Terms in accordance with applicable
        law, and such changes will be effective on the date specified in
        the notice. Your continued use of or access to the Services
